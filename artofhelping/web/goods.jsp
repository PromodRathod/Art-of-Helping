<%-- 
    Document   : goods
    Created on : 6 Oct, 2019, 12:46:46 PM
...
<div id="mySidenav" class="sidenav">
  <a href="adminhome.jsp" id="back">Back</a>
        ...
        <br>
        <h3>All the Donated Details Waiting for Approval</h3>
        <table border="2">
            <center>
   <tr>
        <td>ID</td>
        ...
        <%
            ...
            while(rs.next()) {  %>
                 ...
                 <td><%=rs.getString("item_qty")%></td></tr>
        <%           
            }
            con.close(); 
        }
...
<div style="margin:25px">
    ...
    <h3>Add New WareHouse Details</h3>

<div class="container">
<form class="modal-content" action="manageprod.jsp" method="post">
