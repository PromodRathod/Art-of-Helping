<%-- 
    Document   : join
    Created on : 23 Sep, 2019, 6:30:56 PM
...
<br>
      <h1>Sign Up</h1>
      <p>Please fill in this form to join the group.</p>
      <br>
</div></div>
...
<div class="container">
<form class="modal-content" action="grpdt.jsp" method="post">
    
    <div style="float:left;">
        Name : <input type="text" name="name"><br>
    </div>
    <div style="float:right;">
	Age : <input type="text" name="age" style="float:right;"><br>
    </div>
    <br><br><br><br><br>
    <div style="float:left;">
